"""A setuptools based setup module for M_Pool

See:
http://m_pool.readthedocs.org/en/latest/
https://github.com/sonofeft/M_Pool

If installing from source, then
the best way to install M_Pool is to use pip after navigating to the source directory::
...
target_file = path.join( here, 'm_pool','_version.py')
...
setup(
    ...
    description = 'A wrapper for numpy arrays providing named axes, interpolation, iteration, disk persistence and numerical calcs',
    long_description = long_description,

    # The project's main homepage.
    url='http://m_pool.readthedocs.org/en/latest/',
    ...
    test_suite='m_pool.tests', # allows "setup.py test" to work
